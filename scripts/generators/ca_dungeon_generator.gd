...
var ROOM_MIN_WIDTH = 9 * UGen.SCALE_FACTOR
var ROOM_MAX_WIDTH = 11 * UGen.SCALE_FACTOR
var ROOM_MIN_LENGTH = 9 * UGen.SCALE_FACTOR
var ROOM_MAX_LENGTH = 11 * UGen.SCALE_FACTOR
